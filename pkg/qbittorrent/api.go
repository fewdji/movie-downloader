...
func (client *Client) PauseOne(hash string) (bool, error) {
	return client.Pause([]string{hash})
}
...
func (client *Client) ResumeOne(hash string) (bool, error) {
	return client.Resume([]string{hash})
}
...
func (client *Client) Delete(hashes []string, deleteFiles bool) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/delete", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) DeleteOne(hash string, deleteFiles bool) (bool, error) {
	return client.Delete([]string{hash}, deleteFiles)
}

// Recheck torrents
func (client *Client) Recheck(hashes []string) (bool, error) {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/recheck", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) Reannounce(hashes []string) (bool, error) {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/reannounce", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) DownloadLinks(links []string, opts DownloadOptions) error {
	...
	if len(links) == 0 {
		...
		// Why is encoding causing problems now?
...
func (client *Client) DownloadLink(link string, category string, rename string, sequentialDownload bool, managment bool, savepath string) error {
	...
	if savepath != "" {
		downloadOpts.Savepath = &savepath
	}

	return client.DownloadLinks([]string{link}, downloadOpts)
}
...
func (client *Client) AddTrackers(hash string, trackers []string) error {
	...
	resp, err := client.postMultipartData("api/v2/torrents/addTrackers", params)
	if err != nil {
		return err
...
func (client *Client) EditTracker(hash string, origURL string, newURL string) error {
	...
	resp, err := client.postMultipartData("api/v2/torrents/editTracker", params)
	if err != nil {
		return err
	}
...
func (client *Client) RemoveTrackers(hash string, trackers []string) error {
	...
	resp, err := client.postMultipartData("api/v2/torrents/removeTrackers", params)
	if err != nil {
		return err
	}
...
func (client *Client) IncreasePriority(hashes []string) error {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/increasePrio", opts)
	if err != nil {
		return err
	}
...
func (client *Client) DecreasePriority(hashes []string) error {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/decreasePrio", opts)
	if err != nil {
		return err
	}
...
func (client *Client) MaxPriority(hashes []string) error {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/topPrio", opts)
	if err != nil {
		return err
	}
...
func (client *Client) MinPriority(hashes []string) error {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/bottomPrio", opts)
	if err != nil {
		return err
	}
...
func (client *Client) FilePriority(hash string, ids []int, priority int) error {
	...
	resp, err := client.postMultipartData("api/v2/torrents/filePrio", opts)
	if err != nil {
		return err
	}
...
func (client *Client) GetTorrentDownloadLimit(hashes []string) (limits map[string]int, err error) {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/downloadLimit", opts)
	if err != nil {
		return limits, err
	}
...
func (client *Client) SetTorrentDownloadLimit(hashes []string, limit int) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/setDownloadLimit", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) SetTorrentShareLimit(hashes []string, ratioLimit int, seedingTimeLimit int) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/setShareLimits", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) GetTorrentUploadLimit(hashes []string) (limits map[string]int, err error) {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/uploadLimit", opts)
	if err != nil {
		return limits, err
	}
	json.NewDecoder(resp.Body).Decode(&limits)
...
func (client *Client) SetTorrentUploadLimit(hashes []string, limit int) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/setUploadLimit", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) SetTorrentLocation(hashes []string, location string) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/setLocation", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) SetTorrentName(hash string, name string) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/rename", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) SetTorrentCategory(hashes []string, category string) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/setCategory", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) CreateCategory(category string, savePath string) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/createCategory", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) UpdateCategory(category string, savePath string) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/editCategory", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) DeleteCategories(categories []string) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/removeCategories", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) AddTorrentTags(hashes []string, tags []string) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/addTags", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) RemoveTorrentTags(hashes []string, tags []string) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/removeTags", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) GetTorrentTags() (tags []string, err error) {
	resp, err := client.postMultipartData("api/v2/torrents/tags", nil)
	if err != nil {
		return nil, err
	}
...
func (client *Client) CreateTags(tags []string) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/createTags", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) DeleteTags(tags []string) (bool, error) {
	opts := map[string]string{"tags": delimit(tags, ",")}
	resp, err := client.postMultipartData("api/v2/torrents/deleteTags", opts)
	if err != nil {
		return false, err
	}
...
func (client *Client) SetAutoManagement(hashes []string, enable bool) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/setAutoManagement", opts)
	if err != nil {
		return false, err
	}
	return resp.StatusCode == 200, nil
...
func (client *Client) ToggleSequentialDownload(hashes []string) (bool, error) {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/toggleSequentialDownload", opts)
	if err != nil {
		return false, err
	}
	return resp.StatusCode == 200, nil
...
func (client *Client) ToggleFirstLastPiecePriority(hashes []string) (bool, error) {
	opts := map[string]string{"hashes": delimit(hashes, "|")}
	resp, err := client.postMultipartData("api/v2/torrents/toggleFirstLastPiecePrio", opts)
	if err != nil {
		return false, err
	}
	return resp.StatusCode == 200, nil
...
func (client *Client) SetForceStart(hashes []string, value bool) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/setForceStart", opts)
	if err != nil {
		return false, err
	}
	return resp.StatusCode == 200, nil
...
func (client *Client) SetSuperSeeding(hashes []string, value bool) (bool, error) {
	...
	resp, err := client.postMultipartData("api/v2/torrents/setSuperSeeding", opts)
	if err != nil {
		return false, err
	}
	return resp.StatusCode == 200, nil
